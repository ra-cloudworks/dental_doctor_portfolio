    ...
    <footer style={{ backgroundColor: C.forestGreen, fontFamily: C.sans, color: '#fff' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12 text-left">
          ...
          {/* Doctor info */}
          <div
            className={`md:col-span-5 space-y-5 transition-all duration-700 transform ${
              vis ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
          >
            <h2
              className="text-xl sm:text-2xl font-normal tracking-wide"
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  style={{ border: '1px solid rgba(184,150,108,0.4)', color: C.gold }}
                  onMouseEnter={e => {
          ...
          {/* Quick Links */}
          <div
            className={`md:col-span-3 space-y-5 transition-all duration-700 delay-100 transform ${
              vis ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
          >
            <h3
            ...
            <ul className="space-y-3">
              {quickLinks.map((lk, i) => (
                <li key={i}>
                  <Link
                    to={lk.href}
                    className="text-xs sm:text-sm font-light block py-0.5 transition-colors duration-200"
          ...
          {/* Clinic location */}
          <div
            className={`md:col-span-4 space-y-5 transition-all duration-700 delay-200 transform ${
              vis ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
          >
            <h3
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.10)' }}>
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 py-7 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          <p className="text-xs font-light" style={{ color: 'rgba(255,255,255,0.45)' }}>
            &copy; 2026 Dr. Chandrika Lakshmi Popuri. All Rights Reserved. Prosthodontics &amp; Implant Specialist.
          </p>
