...
export default function Specialties() {
  ...
  return (
    <div style={{ backgroundColor: C.creamBg, fontFamily: C.sans }}>
      ...
      <section
        id="implantology"
        className="py-24 px-6 sm:px-8 lg:px-16 scroll-mt-20"
        style={{ backgroundColor: C.creamBg, borderTop: '1px solid rgba(4,35,30,0.06)' }}
      >
        <div className="max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-7 space-y-8 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pl-5 pt-2">
                {[
                  ...
                  <div
                    key={i}
                    className="rounded-2xl p-8 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md bg-white"
      ...
      >
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Link
            to="/book"
            className="inline-block font-bold py-4 px-10 rounded-lg transition-all duration-300 hover:shadow-xl hover:scale-105 text-sm tracking-widest uppercase text-center cursor-pointer"
